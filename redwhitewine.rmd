...
It seems _total.sulfur.dioxide_ is bimodal. This might be a distinguishing
feature for red vs white wines.
...
With this realization, the best strategy in finding good wines trough these 
variables seem to try to classify them in one of 3 categories first: *red*,
*dry-white* or *sweet-white*.
Both in identifying red from white or dry from sweet, _density_ and _residual 
sugar_ were good variables.
_Alcohol_ can then be added to the specific model to predict good wines.
